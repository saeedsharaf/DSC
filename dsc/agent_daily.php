...
if($access == 'agent'){
  ...
  $queue = $_GET['queue'];
   ...
   $_SESSION['month'] = $month; 
    ...
    $sql_current = "select * from agent where month = '$month' and year = '$year' and login_id = '$login_id'  ";
    //echo $sql_current;
  ...
  <div class="wrapper">
    ...
    <div class="main-panel">
      ...
      <div class="content">
        ...
        <?php
          if($access == 'super' or $access == 'agent' ){
        ...
        <div class="row">
          ...
          <div class="col-lg-4">
            ...
            <?php
             include'../assets/demo/agent_demo.php';
          }
        ...
        ?>
          ...
          <div class="col-lg-6 col-md-12">
            <div class="card" style="width: 215%;margin-left: -15px;">
              <div class="card-header">
                <h4 class="card-title" id="agent_name"></h4>
              </div>
              <div class="card-body">
                        ...
                        $result_current = $connect->query($sql_current);
                         while($row_current = $result_current->fetch_assoc()){
                          ...
                          <tr class="text-center">
                            ...
                            <td><?php echo $row_current['held_percentage'] . ' %' ; ?>                       </td>  
                  ...
                  <div class="row">
                    <div class="col-md-4 pr-md-1">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" disabled="" placeholder="<?php echo $attr_1;  ?>" value="" name="manger_name">
                    ...
                    <div class="col-md-4 px-md-1">
                      <div class="form-group">
                       ...
                       <input type="text" class="form-control" disabled="" placeholder="<?php echo $attr_2;  ?>" value="" name="manger_name">
                      </div>
                    </div>
                    <div class="col-md-4 pl-md-1">
                      <div class="form-group">
                        <label>Attribute 3</label>
                        <input type="text" class="form-control" disabled="" placeholder="<?php echo $attr_3;  ?>" value="" name="manger_name">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-4 pr-md-1">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" disabled="" placeholder="<?php echo $attr_4;  ?>" value="" name="manger_name">
                      </div>
                    </div>
                    <div class="col-md-4 px-md-1">
                      <div class="form-group">
                        <label>Attribute 5</label>
                        <input type="text" class="form-control" disabled="" placeholder="<?php echo $attr_5;  ?>" value="" name="manger_name">
                      </div>
                    </div>
                    <div class="col-md-4 pl-md-1">
                      <div class="form-group">
                        <label>Attribute 6</label>
                        <input type="text" class="form-control" disabled="" placeholder="<?php echo $attr_6;  ?>" value="" name="manger_name">
                      </div>
                    </div>
                  </div>
                   ...
                   <div class="row">
                    <div class="col-md-8">
                      <div class="form-group">
                        ...
                        <textarea rows="4" cols="80" class="form-control" placeholder="Here can be your description" name="spv_des" disabled=""><?php echo $spv_des; ?></textarea>
                         </div>
                    </div>
                  </div>
                ...
                <div class="table-responsive">
                  <table class="table tablesorter " style="    font-size: 11px;" id="">
                    ...
                    <tbody>
                      ...
                      <?php
                       //include'../config/connect.php';
                      $sql ="select * from agent_daily where login_id = '$login_id' and month = '$month' order by id ASC";
                      ...
                      if($result->num_rows > 0){
                        ...
                        ?>
                        <script>
                          document.getElementById('agent_name').innerHTML = '<?php echo $row['name'] . "Score";?>';
                        </script>
           ...
           <form action="./notifications.php" method="get">
              <div style="width: 100%;height: 50px;">
                <div style="text-align: center;">
                  <input type="hidden" name="queue1" value="<?php echo $queue;?>">
                  <input type="hidden" name="month" value="<?php echo $month;?>">
                  <input type="hidden" name="year" value="<?php echo $year;?>">
                 <button name="submit" style="height: 30px;border-radius: 5px;" value="<?php echo $login_id;  ?>"> One To One</button>
                </div>
              </div>
            </form>
            <?php
...
?>
 ...
 <!----------------------------------------------------------------------------------------------------------->
  ...
  <div class="fixed-plugin" style="top:206px;width:90px;line-height: 40px;">
    <div class="dropdown show-dropdown" >
      <a href="#" data-toggle="dropdown">
