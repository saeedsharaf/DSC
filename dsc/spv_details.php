...
$sql_month ="select * from dashboard where queue = 'pre' order by id desc";
    ...
    $month = date_format($create_month,'M');
...
/////////////////////////////////////////////////////
  ...
  $sql = "select * from sv_daily where month = '$current_month' and year = '$current_year' and sv_id = '$sv_id'";
  $result = $connect->query($sql);
  $row = $result->fetch_assoc();
  if($result->num_rows > 0){

    $sql_current = "select * from sv_daily where month = '$current_month' and year = '$current_year' and sv_id = '$sv_id' ";
 

  

  }else{
    $sql_last = "select * from sv_daily where sv_id = '$sv_id' order by month desc ";
    $result_last = $connect->query($sql_last);
    $row_last = $result_last->fetch_assoc();
    $month = $row_last['month'];
    $year = $row_last['year'];

    $sql_current = "select * from sv_daily where month = '$month' and year = '$year' and sv_id = '$sv_id' ";
...
<body class="">
  <div class="wrapper">
    ...
    <div class="main-panel">
          ...
          <div class="col-lg-6 col-md-12">
            <div class="card" style="width: 215%;margin-left: -15px;">
              <div class="card-header">
                <h4 class="card-title" style="text-align: center;"> SPV Score</h4>
                      ...
                      <?php
                        $result_current = $connect->query($sql_current);
                         while($row_current = $result_current->fetch_assoc()){
                          $spv_name = $row_current['name'];
                        

                          ?>
                          <tr class="text-center">
                            <td><?php echo $row_current['day']; ?>                          </a></td>
      ...
      <script>
        document.getElementById('spv_name').innerHTML = '<?php echo $spv_name ; ?>';
      </script>
  ...
  <div class="fixed-plugin" style="top:140px;width:90px;line-height: 40px;">
    <div class="dropdown show-dropdown" >
      ...
      <ul class="dropdown-menu" style="width: 320px;display: flex;flex-wrap: wrap;">
        <a href="#" id=""><div class="s">Jun 2019</div></a>
        <a href="#" id=""><div class="s">Jan 2019</div></a>
        <a href="#" id=""><div class="s">Feb 2019</div></a>
        <a href="#" id=""><div class="s">March 2019</div></a>
        <a href="#" id=""><div class="s">April 2019</div></a>
        <a href="#" id=""><div class="s">May 2019</div></a>
        <a href="#" id=""><div class="s">Jun 2019</div></a>
        <a href="#" id=""><div class="s">July 2019</div></a>
        <a href="#" id=""><div class="s">Aug 2019</div></a>
      </ul>
    </div>
  </div>
