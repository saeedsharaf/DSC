...
$month = $_SESSION['month'];
      ...
      include'../config/connect.php';
       ...
       $day = "select * from dashboard where queue = 'pre' and month = '$month' order by id desc limit 10";
  ...
  //$connect = mysqli_connect('localhost','root','','dsc');
            ...
            global $connect;
            $day = "select * from dashboard where queue = 'pre' limit 10";
            $day_result = $connect->query($day);
...
///////////////////////////////////////// SL //////////////////////////////////////////
   ...
   var sl_day = [
    ...
    <?php
       ...
       $sl = "select * from dashboard where queue = 'pre' and month = '$month' ";
            ...
            if ($sl_result->num_rows > 0 ){
               $x = $sl_result->num_rows ;
                ...
                while($sl_row = $sl_result->fetch_assoc()){
                   $sl_score = (($sl_row['acd_thr1'] + $sl_row['acd_thr2'] + $sl_row['acd_thr3'] + $sl_row['acd_thr4'] + $sl_row['acd_thr5'] ) / ($sl_row['call_offered'] - ($sl_row['abn_thr1'] + $sl_row['abn_thr2'] + $sl_row['abn_thr3'] + $sl_row['abn_thr4'] + $sl_row['abn_thr5'] ))) * 100 ;
                  if($x > 10){
                    $x--;
                    continue ;
  ...
  var myChartSL = new Chart(ctx, config);
   ...
   $("#1").click(function() {
      var sl_data = [
       ...
       $sl = "select * from dashboard where queue = 'post' and month = $month ";
            $sl_result = $connect->query($sl);
            if ($sl_result->num_rows > 0 ){
               $x = $sl_result->num_rows ;
    ...
    $("#2").click(function() {
      var sl_data = [
       ...
       $sl = "select * from dashboard where queue = 'activation' and month = '$month' ";
            $sl_result = $connect->query($sl);
            if ($sl_result->num_rows > 0 ){
               $x = $sl_result->num_rows ;
...
$absent = "select * from dashboard where queue = 'pre' and month = '$month' ";
...
?>
    ...
    $("#1").click(function() {
      ...
      $absent = "select * from dashboard where queue = 'post' and month = '$month' ";
      $absent_result = $connect->query($absent);
            if ($absent_result->num_rows > 0 ){
    ...
    $("#2").click(function() {
      ...
      $absent = "select * from dashboard where queue = 'activation' and month = '$month' ";
      $absent_result = $connect->query($absent);
            if ($absent_result->num_rows > 0 ){
...
///////////////////////////////////////////////  nps   ////////////////////////////////////
    ...
    var chart_data = [
    <?php
    $nps = "select * from dashboard where queue = 'pre' and month = '$month'";
    ...
    $("#1").click(function() {
      var chart_data = [
          ...
          <?php
            $nps = "select * from dashboard where queue = 'post' and month = '$month'";
            $nps_result = $connect->query($nps);
            if ($nps_result->num_rows > 0 ){
              $n = $nps_result->num_rows ;
    ...
    $("#2").click(function() {
      var chart_data = [
            <?php
            $nps = "select * from dashboard where queue = 'activation' and month = '$month'";
            $nps_result = $connect->query($nps);
            if ($nps_result->num_rows > 0 ){
              $n = $nps_result->num_rows ;
...
<?php
            ...
            $aht = "select * from dashboard where queue = 'pre' and month = '$month'";
    ...
    $("#0").click(function() {
     ...
     $("#1").click(function() {
      ...
      <?php
            ...
            $aht = "select * from dashboard where queue = 'post' and month = '$month'";
            $aht_result = $connect->query($aht);
            if ($aht_result->num_rows > 0 ){
              $a = $aht_result->num_rows ;
     ...
     $("#2").click(function() {
      ...
      <?php
            ...
            $aht = "select * from dashboard where queue = 'activation' and month = '$month'";
            $aht_result = $connect->query($aht);
            if ($aht_result->num_rows > 0 ){
              $a = $aht_result->num_rows ;
