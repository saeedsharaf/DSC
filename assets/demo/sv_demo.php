<?php
  ...
  //$connect = mysqli_connect('localhost','root','','dsc');
            global $connect;
            $day = "select * from dashboard where queue = 'pre' limit 10 "; /// //////// to get last 10 day's ignore pre
            $day_result = $connect->query($day);
...
///////////////////////////////////////// hold //////////////////////////////////////////
   ...
   var sl_day = [
    ...
    <?php
       ...
       $sl = "select * from sv_daily where sv_id = '$login_id' and month = '$month' ";
...
<?php
$connect = mysqli_connect('localhost','root','','dsc');
$acw = "select * from sv_daily where sv_id = '$login_id' and month = '$month'  ";
...
///////////////////////////////////////////////  nps   ////////////////////////////////////
    ...
    var chart_data = [
    <?php
    $nps = "select * from sv_daily where sv_id = '$login_id' and month = '$month' ";
...
<?php
            ...
            $aht = "select * from sv_daily where sv_id = '$login_id' and month = '$month' ";
